        ...
        <View style={styles.card}>
          <View style={styles.riskContainer}>
            <View style={styles.riskGauge}>
              <View style={styles.gaugeCircle}>
                <View style={styles.gaugeInner}>
                  <Text style={styles.gaugeTitle}>RISK</Text>
                  <Text style={styles.gaugeSubtitle}>HACKDMTY.COM - 25/10/2025</Text>
                </View>
                <View style={[styles.gaugeArc, styles.gaugeLow]} />
                <View style={[styles.gaugeArc, styles.gaugeMedium]} />
                <View style={[styles.gaugeArc, styles.gaugeHigh]} />
            ...
            <View style={styles.riskInfo}>
              <Text style={styles.riskLabel}>Puntuaje: <Text style={styles.riskValue}>70</Text></Text>
